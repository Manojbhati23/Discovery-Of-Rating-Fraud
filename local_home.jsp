...
<div style="border: solid 1px;border-color: white;border-radius: 2px;height: 680px;width: 1365px;">
    <div style="margin-left: 50px;background-image: url('img/bannerlcl.jpg');margin-top: 190px;border: solid;border-radius: 15px;border-color: gray;height: 380px;width: 1250px">
        <center><br><br>
