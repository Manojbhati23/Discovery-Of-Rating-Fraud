        ...
        <header>
            ...
            <nav class="navbar navbar-default navbar-static-top my_navbar clearfix" role="navigation">
              ...
              <li class="sub-menu"><a href="about.html">App Store<span></span></a><em></em>
                    <ul class="submenu">
                            <li class="active"><a href="globallogin.jsp">Global Anamoly</a></li>
                            <li><a href="locallogin.jsp">Local Anamoly</a></li>
                            </li>
                            <li class="triangle"></li>
                    </ul>
                  </li>
                  <li><a href="userlogin.jsp">User Login</a><em></em></li>
...
<div style="border: solid 1px;border-color: white;border-radius: 2px;height: 680px;width: 1365px;">
    <div style="margin-left: 260px;background-image: url('img/banner9.jpg');margin-top: 200px;border: solid;border-radius: 15px;border-color: gray;height: 400px;width: 800px">
        <center><br><br><br>
            <h2 style="color: white">Global Anamoly Login</h2><br>
            <form action="global_action.jsp" method="post">
