                        ...
                        <ul class="nav sf-menu clearfix">
                            ...
                            <li class="sub-menu"><a href="about.html">App Store<span></span></a><em></em>
                                <ul class="submenu">
                                    ...
                                    <li class="active"><a href="locallogin.jsp">Local Anamoly</a></li>
                            </li>
        ...
        <div class="global">
            <div style="background-image: url('img/picture1.jpg');height: 680px;width: 1365px">
                ...
                <div style="border: solid 1px;border-color: white;border-radius: 2px;height: 680px;width: 1365px;">
                    <div style="margin-left: 260px;background-image: url('img/bannerloc.jpg');margin-top: 200px;border: solid;border-radius: 15px;border-color: gray;height: 400px;width: 800px">
                        <center><br><br><br>
                            <h2 style="color: white">Local Anamoly Login</h2><br>
                            <form action="localaction.jsp" method="post">
