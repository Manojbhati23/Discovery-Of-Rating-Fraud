        ...
        <header>
            ...
            <nav class="navbar navbar-default navbar-static-top my_navbar clearfix" role="navigation">
                <ul class="nav sf-menu clearfix">
                    <li  class="active"><a href="globalhome.jsp">Home</a><em></em></li>
                    <li><a href="user_details.jsp">Users Detail</a><em></em></li>
...
<div style="border: solid 1px;border-color: white;border-radius: 2px;height: 680px;width: 1365px;">
    <div style="margin-left: 50px;background-image: url('img/banner4.jpg');margin-top: 190px;border: solid;border-radius: 15px;border-color: gray;height: 430px;width: 1250px">
        <center><br><br>
            <h2 style="color: red">Welcome to global Anamoly</p></h2><br>
