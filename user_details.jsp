        ...
        <header>
            ...
            <nav class="navbar navbar-default navbar-static-top my_navbar clearfix" role="navigation">
                <ul class="nav sf-menu clearfix">
                    ...
                    <li class="active"><a href="user_details.jsp">User Deatail</a><em></em></li>
                    <li><a href="upload_apps.jsp">Upload Apps</a><em></em></li>
...
<div style="border: solid 1px;border-color: white;border-radius: 2px;height: 680px;width: 1360px;">
    <div style="margin-left: 120px;background-image: url('img/banner10.jpg');margin-top: 190px;border: solid;border-radius: 15px;border-color: gray;height: 400px;width: 1100px">
        <center><br><br>
            <h2 style="color: darkblue">Users Account Detail</p></h2>
        </center>
        <center>
        <table style=" margin-left: 00px;width:85%;position:relative;">
            <tr align="center" style="font-family:verdana;font-size:20px;font-weight: bold ;color: blue">
