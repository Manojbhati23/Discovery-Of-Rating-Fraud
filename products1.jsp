        ...
        <header>
            ...
            <nav class="navbar navbar-default navbar-static-top my_navbar clearfix" role="navigation">
                <ul class="nav sf-menu clearfix">
                    <li><a href="local_home.jsp">Home</a><em></em></li>
                  <li class="active"><a href="products1.jsp">Rate Mobile Apps</a><em></em></li>
                  <li><a href="locallogin.jsp">Logout</a></li>
                </ul>
            </nav>
            <em></em></header>
    </div>
...
//                            System.out.println("Search " + sname);
                    ...
                    <center>
                        <img src="img/<%=fname%>.jpg" alt="fine" style="width: 150px;height: 150px;margin-left: 150px"></img><br /><br />
                            <h3 style="margin-left: 150px;color: white">Name : <%=rs.getString("file_name")%></h3><br>
                            <h3 style="margin-left: 140px;color: white">Download Rating : <%=rs.getString("download")%></h3><br>
                            <form action="local_rate.jsp" method="post">
                                <input type="hidden" value="<%=fname%>" name="filename">
                                <select style="width: 150px;margin-left: 150px;height: 30px;border-radius: 5px;font-size: 18px" name="ratingstatus">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <option selected="">Fake Ranking</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                            ...
                            <input type="submit" value="Update Fake Ranking" style="margin-left: 150px;border-radius: 5px"><br /><br /><br />
                            </form>
                                </center>
                        </td>  
                        <%
